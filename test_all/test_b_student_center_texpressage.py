...
class test_b_student_center_texpressage(unittest.TestCase):
    def setUp(self):
    ...
    def test_b_student_center_texpressage(self):
        u"""学员中心-报名-快递发放"""
...
# 报名
        ...
        time.sleep(2)
#快递发放
        driver.find_element_by_xpath('//*[@id="reservation"]/div/div/ul/li/div[3]/div/div[2]/div/div[2]/table/tbody/tr[3]/td[2]/span/button[1]').click()
        #driver.find_element_by_xpath("//button[contains(.,'快递发放')]").click()
        time.sleep(2)
     #选择教材
