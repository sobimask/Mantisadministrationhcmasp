...
class test_c_student_center_service(unittest.TestCase):
    def setUp(self):
    ...
    def test_c_student_center_service(self):
        u"""学员中心-客服单可现显示"""
...
# 客服单
        ...
        time.sleep(2)
# 断言  -验证客服单可显示
        masg = driver.find_element_by_xpath('//*[@id="hisroot"]/div/div/section/div/div/div/section/main/div/div/div/section/section/main/section/main/section/main/section/div/div/header/div/div/h2').text
        print(masg)
        self.assertIn('客服单',masg)
