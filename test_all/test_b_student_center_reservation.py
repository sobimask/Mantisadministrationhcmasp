...
class test_a_student_center_reservation(unittest.TestCase):
    def setUp(self):
    ...
    def test_a_student_center_reservation(self):
        u"""学员中心-预约记录"""
        ...
        time.sleep(2)
# 预约记录
        driver.find_element_by_link_text('预约记录').click()
        time.sleep(2)
# 断言  -验证预约纪录页面可以显示
        masg = driver.find_element_by_xpath('//*[@id="hisroot"]/div/div/section/div/div/div/section/main/div/div/div/section/section/main/section/main/section/main/section/header/div/div/div/div/label/span[2]').text
        print(masg)
