...
class test_a8_commodity_manage(unittest.TestCase):
    ...
    def test_a8_commodity_manage(self):
        ...
        #新增班型名称
        commodity_name1=product_manage['commodity_name1']
        #商品最低价格
        ...
        #用于转班选择班型
        with open('D:\\Mantisadministrationhcmasp\\configFile\\commodity_name1.txt', 'w', encoding='utf-8') as f:
            f.write(commodity_name1)
            f.close()
...
#查询
        ...
        #商品名称
        driver.find_element_by_xpath("(//input[@id='name'])[2]").send_keys(commodity_name1)
        time.sleep(1)
    ...
    #商品管理
        ...
        driver.find_element_by_id('name').send_keys(commodity_name1)
        driver.find_element_by_xpath("//button[contains(.,'查 询')]").click()
        time.sleep(2)
    #断言
        ...
        print(masg)
        self.assertEqual(masg,commodity_name1)
        time.sleep(2)
