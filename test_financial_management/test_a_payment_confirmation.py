...
class test_a_payment_confirmation(unittest.TestCase):
    def setUp(self):
...
#传入参数
        ...
        with open('D:\\Mantisadministrationhcmasp\\configFile\\student1.txt', 'w') as f:
...
#财务管理
        ...
        time.sleep(2)
    #驳回
        driver.find_element_by_xpath('//*[@id="hisroot"]/div/div/section/div/div/div/section/main/div/section/main/div/div/div/div/div/div/div/div[2]/div[2]/div/div/table/tbody/tr[1]/td[2]/span[2]/span/a').click()
        time.sleep(2)
        #驳回原因
        driver.find_element_by_xpath('//*[@id="rejectReason"]').click()
        driver.find_element_by_xpath('//*[@id="rejectReason"]').send_keys('信息有误')
        time.sleep(1)
        #保存
