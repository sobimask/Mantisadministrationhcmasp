...
class test_a_workorder_masnage(unittest.TestCase):
    ...
    #教学运营
        ...
        driver.find_element_by_xpath('/html/body/div[4]/div/div[2]/div/div[2]/div[2]/div/div/div/div/div[1]/div/div[3]/div/div[2]/div/span/input').send_keys('SD')
        #
...
#处理
        driver.find_element_by_xpath('//*[@id="hisroot"]/div/div/section/div/div/div/section/main/div/section/main/div/div/div/div/div/div/div/div[2]/div[3]/div[2]/div/table/tbody/tr[1]/td/span/span[1]/a').click()
        time.sleep(1)
        #工单备注
        ...
        driver.find_element_by_id('content').send_keys('工单内容')
        #工单完成
        driver.find_element_by_xpath('//*[@id="followUpEdit"]/div[1]/div[2]/form/div[7]/div/div/span/button').click()
        time.sleep(2)
    #返回
...
#d断言
        ...
        print(masg)
        self.assertEquals(masg,'已处理')
    #取消
        driver.find_element_by_xpath('//*[@id="hisroot"]/div/div/section/div/div/div/section/main/div/section/main/div/div/div/div/div/div/div/div[2]/div[3]/div[2]/div/table/tbody/tr[2]/td/span/span[2]/a').click()
        time.sleep(1)
        #确定
        driver.find_element_by_xpath('/html/body/div[3]/div/div/div/div[2]/div/div/div[2]/button[2]').click()
        time.sleep(2)
        masg=driver.find_element_by_xpath('//*[@id="hisroot"]/div/div/section/div/div/div/section/main/div/section/main/div/div/div/div/div/div/div/div[2]/div[1]/div[2]/table/tbody/tr[2]/td[5]/span').text
        print(masg)
        self.assertEquals(masg,'已取消')
