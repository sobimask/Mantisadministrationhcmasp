...
class test_a_student_infrom(unittest.TestCase):
    ...
    #站内信通知
        ...
        driver.find_element_by_xpath('/html/body/div[2]/div/div[2]/div/div[2]/div[2]/form/div[1]/div[1]/div/div[2]/div/span/input').send_keys(commodity_infrom)
        #类型
...
#断言
        ...
        time.sleep(1)
        driver.find_element_by_id('title').send_keys(commodity_infrom)
